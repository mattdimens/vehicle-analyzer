...
const faqJsonLd = {
    ...
    "@type": "FAQPage",
    mainEntity: [
        { "@type": "Question", name: "How do I measure my truck bed length?", acceptedAnswer: { "@type": "Answer", text: "Measure from the inside of the bulkhead to the inside of the tailgate, at the floor, with the tailgate closed. Common lengths are 5'7\" (short), 6'4\"–6'6\" (standard), and 8' (long). Or upload a photo and the AI figures it out from the image." } },
