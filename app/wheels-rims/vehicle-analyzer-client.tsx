...
const steps: HowItWorksStep[] = [
    {
        ...
        description:
            "Take a clear photo of your vehicle's wheel, either a close-up or full side view. Our AI works with any angle, whether the car is on the ground, on a lift, or in your driveway.",
    },
    {
