            ...
            <div className="container max-w-3xl">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-base leading-relaxed text-muted-foreground">
                            The cab style (regular, extended/King Cab/Double Cab, or crew cab) determines which bed lengths are available for your truck. A crew cab F-150 comes with a 5'7" or 6'5" bed, while a regular cab gets the full 8'. Cab style also affects{" "}
