    ...
    useEffect(() => {
        ...
        const fetchVehicles = async () => {
            ...
            try {
                ...
                if (data) {
                    setVehicles(data as unknown as GarageVehicle[])
                }
            } catch (error) {
        ...
        return (
            <div className="bg-white rounded-[2rem] border border-border/40 shadow-sm p-8 md:p-16 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground mb-8 max-w-md">
                    Upload a photo of your car, truck, or SUV to identify it and instantly find compatible parts and accessories.
                </p>
