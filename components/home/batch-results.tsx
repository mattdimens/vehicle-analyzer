    ...
    return (
        <div className="space-y-6">
            ...
            <div className="mx-2 flex items-center gap-1.5 text-xs text-muted-foreground/70">
                ...
                <p>
                    We earn a small commission from Amazon purchases made through our links, at no extra cost to you. This helps keep Visual Fitment free. Product recommendations are generated by our technology and may not reflect every available option.{" "}
